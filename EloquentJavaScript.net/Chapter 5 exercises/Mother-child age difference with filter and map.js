...
everyoneWithAMother = ancestry.filter(function(person) {
    if(person.hasOwnProperty('mother')) return true;
    else return false;
});
...
everyoneWithAMother.map( function(person) {
